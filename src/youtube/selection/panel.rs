...
pub fn build_selection_text(
    req: &YoutubeRequest,
    sel: &super::super::download::Selection,
...
pub async fn refresh_full_panel(
    api: &Bot,
    message: &frankenstein::types::Message,
    req: &YoutubeRequest,
    request_id: u64,
...
) -> Option<&frankenstein::types::Message> {
